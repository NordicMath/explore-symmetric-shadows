...
A very central property of zeta types and number sequences in general, is the notion of there being some linear recursion giving the values. We define the rational shadow, as an important symmetric shadow for which many others factor through. The elements in the image of the rational shadow are not themselves linearly recursive, but the $\lambda$-shadows are. The rational shadow is surprisingly simple to define in purely algebraic terms, and we provide abstract reason why many others factor through it. 
